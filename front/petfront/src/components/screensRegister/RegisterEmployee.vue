        ...
        <form>
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="cpf" required placeholder="xxx.xxx.xxx-xx">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="cel" required placeholder="(xx)xxxxx-xxxx">
                </div>
            </div>
