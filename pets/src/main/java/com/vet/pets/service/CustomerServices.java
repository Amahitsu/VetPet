...
public class CustomerServices{
    ...
    public Customer createCustomer(CustomerCreateDTO dto){
        try{
            Customer newCustomer = customerRepository.save(new Customer(null, dto.name(), dto.cpf(), dto.phone(), dto.email(), dto.active()));
            return newCustomer;
        } catch (Exception e){
    ...
    public Customer updateCustomerById(Long id, CustomerCreateDTO dto){
        try{
            ...
            Customer newCustomer = customerRepository.save(new Customer(id, dto.name(), dto.cpf(), dto.phone(), dto.email(), dto.active()));
            return newCustomer;
        } catch (Exception e){
            throw new RuntimeException(e.getMessage());
        }
